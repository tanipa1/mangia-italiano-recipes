        ...
        <div className='sub-banner py-5'>
            <Container className='w-50 mt-5 px-5 py-5 rounded bg-white '>
                ...
                <Form>
                    ...
                    <Form.Group>
                        <Button className='w-100 py-1 mt-2' variant="outline-primary" size="lg" type="submit">
                    ...
                    <Form.Group>
                        <Button className='w-100 py-1 mt-2' variant="outline-secondary" size="lg" type="submit">
